...
VALUES ('Marry', 'Smith', 19999.81, '+351 326 363 8324', 'marryS10@reverbnation.com',
        '$2a$04$bWi8kKs0kLQi9ao03TrWeemIniME785I3uMISQRfibYwyhl55SJMi', '35645ea7-2b38-430d-aab8-f72302cdc2c8');

INSERT INTO public.customer
VALUES ('Ben', 'Rope', 30001.81, '+42 326 363 8324', 'benRO11P@reverbnation.com',
...
INSERT INTO public.ticket VALUES (1, '0008386672215', 'Premium', 1326.0, 0.0, 1326.0, '2A', 'Marry Smith',
                                  ...
                                  TO_TIMESTAMP('2017-07-16 10:30:00 +02', 'YYYY-MM-DD HH24:MI:SS TZH:TZM'),
                                  1, '35645ea7-2b38-430d-aab8-f72302cdc2c8');
INSERT INTO public.ticket VALUES (2, '0003099269080', 'Business', 5513.0, 0.0, 5513.0, '1A', 'Ben Rope',
                                  TO_TIMESTAMP('2017-07-16 09:35:00 +02', 'YYYY-MM-DD HH24:MI:SS TZH:TZM'),
                                  TO_TIMESTAMP('2017-07-16 10:30:00 +02', 'YYYY-MM-DD HH24:MI:SS TZH:TZM'),
                                  1, '0931192f-35a2-461b-bc85-133290c63c67');
INSERT INTO public.ticket VALUES (3, '0001901266072', 'Economy', 737.0, 0.0, 737.0, '7A', 'John Doe',
                                  TO_TIMESTAMP('2017-07-16 16:35:00 +02', 'YYYY-MM-DD HH24:MI:SS TZH:TZM'),
                                  TO_TIMESTAMP('2017-07-16 20:30:00 + 02', 'YYYY-MM-DD HH24:MI:SS TZH:TZM'),
