...
public class AirportIntegrationTest {
    ...
    public void testCreateAirport() {
        final AirportRequest request = new AirportRequest("QRT", "Rieti Airport", "IT", "IT-62", "Rieti", "LIQN");
    ...
    public void testUpdateAirportById() {
        final Long id = 1L;
        final AirportRequest request = new AirportRequest("BQK", "Glynco Jetport", "US", "US-GA", "Brunswick", "KBQK");
